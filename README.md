...
Claude Code plugin that connects Claude to your Meta, TikTok, Google Ads, and GA4 advertising data via [Platformance](https://platformance.io).
...
1. Sign up at [connect.platformance.io](https://connect.platformance.io) and connect your Meta / TikTok / Google Ads / GA4 accounts.
2. Copy your Platformance API key from the dashboard.
3. In Claude Code: **Add marketplace → Add from a repository** → `https://github.com/MatteMena/matte-claude-plugin`
4. Install the `platformance-connect` plugin and paste your API key when prompted.
